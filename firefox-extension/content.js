  ...
  return `
    <div class="poker-coach-card">
      ...
      <div class="poker-coach-content">
        ...
        <p class="poker-coach-loading-text">Analyzing screenshot...</p>
        <p class="poker-coach-loading-subtext">AI is recognizing cards and game situation</p>
      </div>
    </div>
  `;
}
  ...
  return `
    <div class="poker-coach-card">
      <div class="poker-coach-header">
        ...
        <span class="poker-coach-title">Poker Coach</span>
        <button class="poker-coach-close" aria-label="Close">&times;</button>
      </div>
      <div class="poker-coach-content">
        ...
        ${analysis.heroCards ? `
          <div class="poker-coach-info">
            <strong>Your Cards:</strong> ${analysis.heroCards}
          </div>
        ` : ""}
      ...
      <div class="poker-coach-footer">
        <button class="poker-coach-close poker-coach-btn">Close</button>
      </div>
    </div>
  `;
}
...
function createErrorContent(message) {
  ...
  if (message.length > 150 || message.includes("{") || message.includes("Error:")) {
    cleanMessage = "Analysis failed - please try again";
  }
  ...
  return `
    <div class="poker-coach-card poker-coach-error">
      <div class="poker-coach-header">
        ...
        <span class="poker-coach-title">Error</span>
        <button class="poker-coach-close" aria-label="Close">&times;</button>
      </div>
      <div class="poker-coach-content">
        <p class="poker-coach-error-text">${cleanMessage}</p>
        <p class="poker-coach-error-hint">Press Ctrl+Shift+P to try again</p>
      </div>
      <div class="poker-coach-footer">
        <button class="poker-coach-close poker-coach-btn">Close</button>
      </div>
